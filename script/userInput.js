function user() {
    ...
    userName.textContent = "Samantha Lee";
    userLogo.textContent = "S"
    ...
    userName2.textContent = "Ahmed Hassan";
    userLogo2.textContent = "A"
    user_comment2.textContent = "We've been using PG Mechanical for our annual HVAC checkups for years. Pradeep and his team are always punctual, professional, and thorough. Our energy bills have never been lower!"
    ...
    userName3.textContent = "Elena Kovač";
    userLogo3.textContent = "E"
    user_comment3.textContent = "After struggling with an inefficient heating system, we called PG Mechanical. Pradeep suggested a new, energy-efficient model and handled the installation flawlessly. Our home has never been more comfortable."
    ...
    userName4.textContent = " Anand Srivastav";
    userLogo4.textContent = "A"
    user_comment4.textContent = "As new homeowners, we were clueless about HVAC maintenance. Pradeep from PG Mechanical took the time to educate us and set up a preventive maintenance plan. We're grateful for their patient, informative service."
    const user4={
        Name : userName4,
        logo : userLogo4,
        star : user_star4,
    ...
    userName5.textContent = "Hiroshi Tanaka";
    userLogo5.textContent = "H"
    user_comment5.textContent = "Our data center requires precise temperature control 24/7. PG Mechanical's expertise in commercial HVAC has been crucial to our operations. Pradeep Gosal and his team provide reliable service and cutting-edge solutions."
    const user5={
        Name : userName5,
        logo : userLogo5,
        star : user_star5,
    ...
    userName7.textContent = "Vikram";
    userLogo7.textContent = "V"
    user_comment7.textContent = "As new homeowners, we were clueless about HVAC maintenance. Pradeep from PG Mechanical took the time to educate us and set up a preventive maintenance plan. We're grateful for their patient, informative service."
    const user7={
        Name : userName7,
        logo : userLogo7,
        star : user_star7,
